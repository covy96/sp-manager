...
// Mappa id categoria → tabella Supabase reale per ripristino/eliminazione
const TABELLA_REALE = {
  projects: 'projects',
  commesse: 'commesse',
  offerte:  'offerte',
