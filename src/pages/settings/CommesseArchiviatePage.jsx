          ...
          {commesse.map(c => (
            <div key={c.id} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: T.surface, border: `0.5px solid ${T.border}`, padding: '14px 18px', flexWrap: 'wrap', gap: 12 }}>
              ...
              <div style={{ display: 'flex', gap: 8, flexShrink: 0 }}>
                <button onClick={() => navigate(`/commesse/${c.id}`)} style={{ padding: '6px 12px', background: T.bg, border: `0.5px solid ${T.borderMd}`, fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, color: T.muted, letterSpacing: '0.05em', textTransform: 'uppercase', cursor: 'pointer' }}>Visualizza</button>
