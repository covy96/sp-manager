...
const ALL_SLIDES = [
  ...
  { mock: "lineitems", nav: "/impostazioni/regolazione-offerta", inSettings: true, goto: "/impostazioni/regolazione-offerta", emoji: "📑", titolo: "Regolazione Offerta", testo: "Personalizzi il documento d'offerta: testi fissi, flag di default, prezzi precompilati, voci per sezione e i preset rapidi. Le modifiche valgono per le nuove offerte.", punti: ["Un unico posto per regolare tutto il Word/PDF", "Prezzi e voci pronti, niente importi a memoria"] },
  ...
  { cat: "pratica", mock: "invoice", roles: "pm", minPlan: "studio", goto: "/fatture", plan: "Studio", cta: "Vai a Proforma/Fatture →", emoji: "🧾", titolo: "Emettere proforma e fatture", testo: "Genera i documenti collegati alle rate della commessa e tieni traccia dei pagamenti.", punti: ["Apri la commessa (serve la suddivisione pagamenti già fatta)", "Sezione Proforma/Fattura → + Nuova: seleziona le rate da includere", "Compila numero e data; il documento eredita i dati della commessa", "Segna il pagamento quando incassi: rate e stato si aggiornano"] },
  { cat: "pratica", mock: "capex", minPlan: "pro", goto: "/progetti", plan: "Pro", cta: "Apri un progetto →", emoji: "🏗", titolo: "Compilare il CAPEX", testo: "Il quadro economico del cantiere lato committente: preventivi, accettazione e pagamenti (separato dalla marginalità dello studio).", punti: ["Apri un progetto e tocca la pill CAPEX in alto", "Tab Preventivi: aggiungi i preventivi per categoria (edile, impianti…)", "Confronta più preventivi nella stessa categoria e segna 'Accettato'", "Aggiungi 'extra' collegati allo stesso operatore per le varianti", "Tab Accettati: registra i pagamenti e segui pagato / residuo"] },
  { cat: "pratica", mock: "sitereport", goto: "/progetti", cta: "Apri un progetto →", emoji: "📐", titolo: "Compilare un report di cantiere", testo: "Si compila da dentro il progetto. In Impostazioni → Report si personalizza solo il PDF (intestazione e logo).", punti: ["Apri il progetto e tocca la pill REPORT → nuovo report", "Inserisci data e note del sopralluogo", "Allega le foto da telefono o computer", "Esporta in PDF con intestazione e logo dello studio", "L'aspetto del PDF si imposta una volta in Impostazioni → Report"] },
  { cat: "pratica", mock: "pratiche", goto: "/progetti", cta: "Apri un progetto →", emoji: "🏛", titolo: "Compilare una pratica edilizia", testo: "Si compila da dentro il progetto: tipo, protocollo, stato e scadenze.", punti: ["Apri il progetto e tocca la pill PRATICHE", "Aggiungi la pratica: tipo (CILA, SCIA, PdC…), protocollo, stato", "Imposta le date e le eventuali scadenze", "Le scadenze compaiono nello Scadenzario in Dashboard"] },
  { cat: "pratica", mock: "contacts", goto: "/progetti", cta: "Apri un progetto →", emoji: "👤", titolo: "Aggiungere i contatti del progetto", testo: "L'anagrafica del progetto si gestisce dalla pill ANAGRAFICA dentro il progetto.", punti: ["Apri il progetto e tocca la pill ANAGRAFICA", "Aggiungi committente, impresa, fornitori… con il loro ruolo", "Riusa i contatti già salvati o copiali da un altro progetto", "I dati restano collegati al progetto e ai documenti"] },
  { cat: "pratica", mock: "gantt", minPlan: "studio", nav: "/gantt-progetti", goto: "/gantt-progetti", plan: "Studio", cta: "Vai al Gantt →", emoji: "📅", titolo: "Creare un Gantt", testo: "Pianifica le fasi del progetto su una timeline visiva.", punti: ["Calendario & Gantt → seleziona il progetto", "Aggiungi le lavorazioni con data di inizio e fine", "Trascina le barre per spostare o allungare le fasi", "Salva versioni diverse per confrontare le pianificazioni"] },
  { cat: "pratica", mock: "timesheet", nav: "/timesheet", goto: "/timesheet", cta: "Vai al Timesheet →", emoji: "⏱", titolo: "Registrare le ore (timesheet)", testo: "Le ore inserite alimentano report e analisi di redditività.", punti: ["Timesheet → scegli progetto e settimana", "Inserisci le ore giorno per giorno, con una nota se serve", "Rivedi il totale settimanale per persona", "Le ore confluiscono in Report e Analisi automaticamente"] },
  { cat: "pratica", mock: "team", minPlan: "studio", nav: "/team", goto: "/team", plan: "Studio", cta: "Vai al Team →", emoji: "👥", titolo: "Invitare il team e dare i permessi", testo: "Aggiungi i collaboratori e assegna a ciascuno ruolo e permessi.", punti: ["Copia il codice invito da Profilo Studio e condividilo", "In Team assegna il ruolo (da Titolare a Collaboratore)", "Apri i permessi per affinare cosa può vedere/fare ognuno", "Es. abilitare 'Eliminare contenuti' a un Project Manager"] },
  { cat: "pratica", mock: "analytics", roles: "pm", minPlan: "pro", nav: "/analisi-hub", goto: "/analisi-hub", plan: "Pro", cta: "Vai alle Analisi →", emoji: "📊", titolo: "Leggere Analisi e Report", testo: "Trasforma i dati in decisioni: economia, margini e produttività.", punti: ["Analisi: incassi, margini e andamento offerte", "Report: ore per progetto e per membro, esportabili", "Imposta i costi orari del team per margini realistici"] },
  { cat: "pratica", mock: "tips", goto: "/impostazioni/esporta", cta: "Vai a Esporta dati →", emoji: "📦", titolo: "Esportare i dati", testo: "Scarica i tuoi dati quando vuoi, in autonomia.", punti: ["Impostazioni → Esporta dati", "Scegli cosa esportare e scarica i file", "Utile per backup, commercialista o passaggi di consegne"] },
